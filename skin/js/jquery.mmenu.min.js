      ...
      (e[n].prototype = {
        ...
        closePanel: function (e) {
          ...
          t.hasClass(a.vertical) &&
            (t.removeClass(a.opened), this.trigger('closePanel', e));
        },
        ...
        togglePanel: function (e) {
          var t = e.parent();
          t.hasClass(a.vertical) &&
            this[t.hasClass(a.opened) ? 'closePanel' : 'openPanel'](e);
        },
        ...
        _initPanels: function (t) {
          ...
          this.__refactorClass(d, this.conf.classNames.vertical, 'vertical'),
            ...
            d.each(function () {
              var t = e(this),
                s = t;
              t.is('ul, ol')
                ? (t.wrap('<div class="' + a.panel + '" />'), (s = t.parent()))
                : s.addClass(a.panel);
              var i = t.attr('id');
              t.removeAttr('id'),
          ...
          l.each(function () {
            ...
            if (
              (s.is('.' + a.menu) || (s.data(i.sub, t), t.data(i.parent, s)),
        ...
        _initAnchors: function () {
          ...
          l.$body.on(r.click + '-oncanvas', 'a[href]', function (s) {
            ...
            if (
              ...
              p && s.preventDefault(),
                t.__valueOrFn(t.opts.onClick.blockUI, i, !p) &&
                  l.$html.addClass(a.blocking),
  ...
  (t[e].addons[o] = {
    ...
    clickAnchor: function (t) {
      ...
      if (
        e &&
        e.length &&
        (this.conf.clone && (e = s.umm(e)), t.is('[href="#' + e + '"]'))
      )
        return this.open(), !0;
      if (a.$page) {
    ...
    (t[e].prototype._openSetup = function () {
      ...
      this.opts[o].modal && r.push(s.modal),
        ...
        'back' != this.opts[o].zposition &&
          r.push(s.mm(this.opts[o].zposition)),
    ...
    (t[e].prototype.setPage = function (e) {
      var n = this,
        i = this.conf[o];
      (e && e.length) ||
        ((e = a.$body.find(i.pageSelector)),
        e.length > 1 &&
          i.wrapPageIfNeeded &&
          (e = e.wrapAll('<' + this.conf[o].pageNodetype + ' />').parent())),
        e.each(function () {
    ...
    (t[e].prototype['_initWindow_' + o] = function () {
      a.$wndw
        .off(i.keydown + '-offcanvas')
        .on(i.keydown + '-offcanvas', function (t) {
          return a.$html.hasClass(s.opened) && 9 == t.keyCode
            ? (t.preventDefault(), !1)
            : void 0;
        });
      var t = 0;
      a.$wndw
        .off(i.resize + '-offcanvas')
    ...
    (t[e].prototype._initBlocker = function () {
      ...
      a.$blck ||
        ...
        a.$blck
          ...
          .on(
            i.touchstart + '-offcanvas ' + i.touchmove + '-offcanvas',
            function (t) {
              t.preventDefault(),
                t.stopPropagation(),
          ...
          .on(i.mousedown + '-offcanvas', function (t) {
            t.preventDefault(),
              a.$html.hasClass(s.modal) || (e.closeAllOthers(), e.close());
          });
    });
  var s, n, i, a;
})(jQuery);
    ...
    setup: function () {
      if (this.opts.offCanvas) {
        ...
        var a = function (i) {
          ...
          this.__refactorClass(i.find('.' + s), s, 'slideout').appendTo(
            o.$body,
          );
        };
    ...
    setup: function () {
      ...
      if (((s = n[a].glbl), 'undefined' != typeof i)) {
        ...
        n.each(i, function (s) {
          ...
          b > 1 && f.addClass(t.navbar + '-content-' + b),
            f.children('.' + t.btn).length && f.addClass(t.hasbtns),
            f.prependTo(r.$menu);
        });
        ...
        this.bind('init', function (a) {
          a.removeClass(i.hasnavbar).each(function () {
            for (
              var a = [],
                e = n(this),
                t = n('<span class="' + i.breadcrumbs + '"></span>'),
    ...
    n[a].addons[e][t] = function (t) {
      ...
      var i = function (n) {
        ...
        var a = t.find('.' + r.next),
          ...
          s = i.attr('href'),
          c = i.html();
        a[s ? 'attr' : 'removeAttr']('href', s),
          a[s || c ? 'removeClass' : 'addClass'](r.hidden),
          a.html(c);
      };
    ...
    n[a].addons[e][t] = function (t, r) {
      ...
      var s = function (n) {
        ...
        a[c ? 'attr' : 'removeAttr']('href', c),
          a[c || d ? 'removeClass' : 'addClass'](i.hidden),
          a.html(d);
      };
              ...
              if (!s.is('.' + t.panel) || !s.is('.' + t.vertical)) {
                if (!s.children('.' + t.search).length) {
                  ...
                  a.append(
                    ...
                    s.hasClass(t.search)
                      ? s.replaceWith(a)
                      : s.prepend(a).addClass(t.hassearch);
                }
                if (d.noResults) {
                  var i = s.closest('.' + t.panel).length;
                  if (
                    (i || (s = o.$menu.children('.' + t.panel).first()),
    ...
    setup: function () {
      ...
      this.conf[r],
        ...
        this.bind('init', function (a) {
          ...
          if (
            !this.$indexer &&
            this.$menu.children('.' + n.hasindexer).length
          ) {
            ...
            this.bind('openPanel', s),
              s.call(this, this.$menu.children('.' + n.current));
          }
        });
    },
    add: function () {
