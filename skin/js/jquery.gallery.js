...
(function ($, undefined) {
  ...
  $.Gallery.prototype = {
    _init: function (options) {
      ...
      this.support3d = ModernizrCarousel.csstransforms3d;
      this.support2d = ModernizrCarousel.csstransforms;
      this.supportTrans = ModernizrCarousel.csstransitions;
    ...
    _layout: function () {
      ...
      if (this.support3d && this.supportTrans) {
        leftCSS = {
          '-webkit-transform':
            'translateX(-500px) translateZ(-200px) rotateY(45deg)',
          '-moz-transform':
            'translateX(-500px) translateZ(-200px) rotateY(45deg)',
          '-o-transform':
            'translateX(-500px) translateZ(-200px) rotateY(45deg)',
